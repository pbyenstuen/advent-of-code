 ...
 * @returns {string|null} The content of the `input.txt` file, or `null` if the file doesn't exist or an error occurs.
 */
export const readInputFile = (year: number, day: number): string | null => {
